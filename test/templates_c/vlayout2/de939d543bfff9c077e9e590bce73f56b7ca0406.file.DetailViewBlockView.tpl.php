<?php /* Smarty version Smarty-3.1.7, created on 2015-09-08 05:41:52
         compiled from "D:\xampp\htdocs\demo38\includes\runtime/../../layouts/vlayout2\modules\Vtiger\DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2727055ee7520ec9f26-30736626%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'de939d543bfff9c077e9e590bce73f56b7ca0406' => 
    array (
      0 => 'D:\\xampp\\htdocs\\demo38\\includes\\runtime/../../layouts/vlayout2\\modules\\Vtiger\\DetailViewBlockView.tpl',
      1 => 1441632355,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2727055ee7520ec9f26-30736626',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55ee75211c20a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55ee75211c20a')) {function content_55ee75211c20a($_smarty_tpl) {?>
...
' /><div class="table table-bordered equalSplit detailview-table"><div class="top_header_bar_drag"><div class="main_heading"><div class="blockHeader" colspan="4"><img class="cursorPointer alignMiddle blockToggle <?php if (!($_smarty_tpl->tpl_vars['IS_HIDDEN']->value)){?> hide <?php }?> "  src="<?php echo vimage_path('arrowRight.png');?>
...
</div></div></div><div class="drop_block_bottom_header" <?php if ($_smarty_tpl->tpl_vars['IS_HIDDEN']->value){?> class="hide" <?php }?>><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(0, null, 0);?><div class="detail-row-full"><?php  $_smarty_tpl->tpl_vars['FIELD_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['FIELD_MODEL']->_loop = false;
...
?><?php if ($_smarty_tpl->tpl_vars['tax']->value['check_value']==1){?><?php if ($_smarty_tpl->tpl_vars['COUNTER']->value==2){?></div><div class="detail-row-full"><?php $_smarty_tpl->tpl_vars["COUNTER"] = new Smarty_variable(1, null, 0);?><?php }else{ ?><?php $_smarty_tpl->tpl_vars["COUNTER"] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?><?php }?><div class="width30-per fieldLabel <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
...
(%)</label></div><div class="width20-per fieldValue <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"><span class="value"><?php echo $_smarty_tpl->tpl_vars['tax']->value['percentage'];?>
</span></div><?php }?><?php } ?><?php }elseif($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=="69"||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=="105"){?><?php if ($_smarty_tpl->tpl_vars['COUNTER']->value!=0){?><?php if ($_smarty_tpl->tpl_vars['COUNTER']->value==2){?></div><div><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(0, null, 0);?><?php }?><?php }?><div class="width30-per fieldLabel <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
...
" width="300" height="200"><?php }?><?php } ?></div></div><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=="20"||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=="19"){?><?php if ($_smarty_tpl->tpl_vars['COUNTER']->value=='1'){?><div class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></div><div class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></div></div><div><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(0, null, 0);?><?php }?><?php }?><?php if ($_smarty_tpl->tpl_vars['COUNTER']->value==2){?></div><div><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(1, null, 0);?><?php }else{ ?><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?><?php }?><div class="width30-per fieldLabel <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
...
" <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName()=='description'||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='69'){?> style='width:30%'<?php }?>><label class="muted pull-right marginRight10px"><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label');?>
...
)<?php }?></label></div><div class="width20-per fieldValue <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
" id="<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>
...
' /><?php }?></span><?php }?></div><?php }?><?php if (count($_smarty_tpl->tpl_vars['FIELD_MODEL_LIST']->value)==1&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="19"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="20"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="30"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')!="recurringtype"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="69"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="105"){?><div class="width30-per fieldLabel <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></div><div class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></div><?php }?><?php } ?><?php if (end($_smarty_tpl->tpl_vars['FIELD_MODEL_LIST']->value)==true&&count($_smarty_tpl->tpl_vars['FIELD_MODEL_LIST']->value)!=1&&$_smarty_tpl->tpl_vars['COUNTER']->value==1){?><div class="width30-per fieldLabel <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></div><div class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></div><?php }?></div></div></div><br><?php } ?>

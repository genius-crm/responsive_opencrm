...
//require_once dirname(dirname(dirname(__FILE__))).'third-party/curl_http_client.php';
...
class Vtiger_HTTP_Client extends Curl_HTTP_Client {
	...
	function doPost($postdata=false, $decodeResponseJSON=false, $timeout=20) {
		...
		$resdata = $this->send_post_data($this->_serviceurl, $postdata, null, $timeout);write_log('vtrc',$resdata);

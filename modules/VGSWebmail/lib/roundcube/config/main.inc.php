...
$rcmail_config['smtp_user'] = 'info@vgslgobal.com';

// SMTP password (if required) if you use %p as the password Roundcube
// will use the current user's password for login
$rcmail_config['smtp_pass'] = 'reingenia01';
...
$rcmail_config['des_key'] = 'biGJIGZkf&wb7vGy4YiDKOQU';
...
// %z - IMAP domain (IMAP hostname without the first part)
// For example %n = mail.domain.tld, %t = domain.tld
$rcmail_config['username_domain'] = 'vgsglobal.com';
...
// %z - IMAP domain (IMAP hostname without the first part)
// For example %n = mail.domain.tld, %t = domain.tld
$rcmail_config['mail_domain'] = 'vgsglobal.com';
...
$rcmail_config['plugins'] = array('vtrc','multiple_smtp_server','vtcontacts','vtuserprofile');

<?php /* Smarty version Smarty-3.1.7, created on 2015-08-14 13:15:01
         compiled from "/home/opencrmita/domains/opencrmitalia.com/public_html/demo38/includes/runtime/../../layouts/vlayout2/modules/Accounting/LineItemsContent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:167964340055cde9d58185b7-52186207%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b670ae72f92f3d72e48c3633b461c92800cf5d12' => 
    array (
      0 => '/home/opencrmita/domains/opencrmitalia.com/public_html/demo38/includes/runtime/../../layouts/vlayout2/modules/Accounting/LineItemsContent.tpl',
      1 => 1438433156,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '167964340055cde9d58185b7-52186207',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55cde9d5a3ee1',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55cde9d5a3ee1')) {function content_55cde9d5a3ee1($_smarty_tpl) {?>
...
<?php }else{ ?>1<?php }?>"/><br><?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qtyInStock']->value])){?><span class="stockAlert" style="color: green;"><?php echo vtranslate('Current state storage','Accounting');?>
...
<?php }else{ ?>0<?php }?>" type="text" data-validation-engine="validate[required,funcCall[Vtiger_PositiveNumber_Validator_Js.invokeValidation]]" class="listPrice smallInputBox" /></div><div class="individualTaxContainer <?php if ($_smarty_tpl->tpl_vars['IS_GROUP_TAX_TYPE']->value){?>hide<?php }?>">(+)&nbsp;<b><a href="javascript:void(0)" class="individualTax"><?php echo vtranslate('LBL_TAX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
" align="right" class="discountTotal" style="display:none;"><?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['discountTotal']->value]){?><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['discountTotal']->value];?>
<?php }else{ ?>0.00<?php }?></div><div id="totalAfterDiscount<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
" align="right" class="totalAfterDiscount" style="display:none;"><?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['totalAfterDiscount']->value]){?><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['totalAfterDiscount']->value];?>
<?php }else{ ?>0.00<?php }?></div><div id="taxTotal<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
" align="right" class="productTaxTotal <?php if ($_smarty_tpl->tpl_vars['IS_GROUP_TAX_TYPE']->value){?>hide<?php }?>" style="display:none;"><?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['taxTotal']->value]){?><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['taxTotal']->value];?>

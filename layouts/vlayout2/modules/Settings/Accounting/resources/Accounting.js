 ...
 * All Rights Reserved.
 *************************************************************************************/
jQuery.Class('Accounting_Module_Manager_Js', {
}, {
	...
	updateModuleStatus : function(currentTarget) {
		...
		params['action'] = 'PaymentDetailSaveAjax';
	...
	registerEvents : function(e){
		...
		var container = jQuery('#paymentManagerContents');
...
jQuery(document).ready(function(){
	var settingModuleManagerInstance = new Accounting_Module_Manager_Js();

 ...
 */
class Ddt_Record_Model extends Inventory_Record_Model {

	public function getCreateInvoiceUrl() {
		$invoiceModuleModel = Vtiger_Module_Model::getInstance('Invoice');

		return "index.php?module=".$invoiceModuleModel->getName()."&view=".$invoiceModuleModel->getEditViewName()."&ddtid=".$this->getId();
	}

	public function getCreateSalesOrderUrl() {
		$salesOrderModuleModel = Vtiger_Module_Model::getInstance('SalesOrder');

		return "index.php?module=".$salesOrderModuleModel->getName()."&view=".$salesOrderModuleModel->getEditViewName()."&ddtid=".$this->getId();
	}
	...
	function getInventoryCurrencyInfo($module, $id)	{
		...
		$log->debug("Entering into function Ddt_Record_Model getInventoryCurrencyInfo($module, $id).");

		$inv_table_array = Array('Ddt'=>'green_ddt');
		$inv_id_array = Array('Ddt'=>'ddtid');
		...
		$log->debug("Exit from function Ddt_Record_Model getInventoryCurrencyInfo($module, $id).");
	...
	function getAssociatedProducts($module,$focus,$seid='')	{
		global $log;
		$log->debug("Entering Ddt_Record_Model getAssociatedProducts(".$module.",".get_class($focus).",".$seid."='') method ...");
		global $adb;
		$output = '';
		...
		$log->debug("Exiting Ddt_Record_Model getAssociatedProducts method ...");

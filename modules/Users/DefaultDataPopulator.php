...
class DefaultDataPopulator extends CRMEntity {
	...
	function create_tables() {
		...
		$this->db->query("insert into vtiger_field values (6," . $this->db->getUniqueID("vtiger_field") . ",'tickersymbol','vtiger_account',1,'1','tickersymbol','Ticker Symbol',1,1,'',100,5,9,1,'V~O',1,null,'BAS',1)");
		...
		$this->db->query("insert into vtiger_field values (6," . $this->db->getUniqueID("vtiger_field") . ",'employees','vtiger_account',1,'7','employees','Employees',1,1,'',100,9,9,1,'I~O',1,null,'ADV',1)");
		...
		$this->db->query("insert into vtiger_field values (6," . $this->db->getUniqueID("vtiger_field") . ",'ownership','vtiger_account',1,'1','ownership','Ownership',1,1,'',100,12,9,1,'V~O',1,null,'ADV',1)");
		$this->db->query("insert into vtiger_field values (6," . $this->db->getUniqueID("vtiger_field") . ",'rating','vtiger_account',1,'15','rating','Rating',1,1,'',100,14,9,1,'V~O',1,null,'ADV',1)");
		...
		$this->db->query("insert into vtiger_field values (6," . $this->db->getUniqueID("vtiger_field") . ",'siccode','vtiger_account',1,'1','siccode','SIC Code',1,1,'',100,16,9,1,'V~O',1,null,'ADV',1)");
		...
		$this->db->query("insert into vtiger_field values (6," . $this->db->getUniqueID("vtiger_field") . ",'annualrevenue','vtiger_account',1,'71','annual_revenue','Annual Revenue',1,1,'',100,18,9,1,'I~O',1,null,'ADV',1)");
...
/////////////////////////////////  P.iva e CF  By Greenbitweb - info@greenbitweb.com  /////////////////////////////////
		$this->db->query("insert into vtiger_field values (6," . $this->db->getUniqueID("vtiger_field") . ",'partitaiva','vtiger_account',1,'1','partitaiva','Partita IVA',1,2,'',30,24,9,1,'V~O',1,null,'BAS',1)");
		$this->db->query("insert into vtiger_field values (6," . $this->db->getUniqueID("vtiger_field") . ",'codicefiscale','vtiger_account',1,'1','codicefiscale','Codice Fiscale',1,2,'',30,25,9,1,'V~O',1,null,'BAS',1)");
/////////////////////////////////
		//Block 11
		...
		$this->db->query("insert into vtiger_field values (7," . $this->db->getUniqueID("vtiger_field") . ",'annualrevenue','vtiger_leaddetails',1,'71','annualrevenue','Annual Revenue',1,1,'',100,14,13,1,'I~O',1,null,'ADV',1)");
		$this->db->query("insert into vtiger_field values (7," . $this->db->getUniqueID("vtiger_field") . ",'rating','vtiger_leaddetails',1,'15','rating','Rating',1,1,'',100,17,13,1,'V~O',1,null,'ADV',1)");
		$this->db->query("insert into vtiger_field values (7," . $this->db->getUniqueID("vtiger_field") . ",'noofemployees','vtiger_leaddetails',1,'1','noofemployees','No Of Employees',1,1,'',100,16,13,1,'I~O',1,null,'ADV',1)");
...
/////////////////////////////////  P.iva e CF  By Greenbitweb - info@greenbitweb.com  /////////////////////////////////
        $this->db->query("insert into vtiger_field values (7," . $this->db->getUniqueID("vtiger_field") . ",'partitaiva','vtiger_leaddetails',1,'1','partitaiva','Partita IVA',1,2,'',30,25,13,1,'V~O',1,null,'BAS',1)");
        $this->db->query("insert into vtiger_field values (7," . $this->db->getUniqueID("vtiger_field") . ",'codicefiscale','vtiger_leaddetails',1,'1','codicefiscale','Codice Fiscale',1,2,'',30,26,13,1,'V~O',1,null,'BAS',1)");
/////////////////////////////////
		//Block13 -- End
		//Block15 -- Start
		...
		$this->db->query("insert into vtiger_field values (4," . $this->db->getUniqueID("vtiger_field") . ",'department','vtiger_contactdetails',1,'1','department','Department',1,1,'',100,12,4,1,'V~O',1,null,'ADV',1)");
		...
		$this->db->query("insert into vtiger_field values (4," . $this->db->getUniqueID("vtiger_field") . ",'assistant','vtiger_contactsubdetails',1,'1','assistant','Assistant',1,1,'',100,17,4,1,'V~O',1,null,'ADV',1)");
		...
		$this->db->query("insert into vtiger_field values (4," . $this->db->getUniqueID("vtiger_field") . ",'assistantphone','vtiger_contactsubdetails',1,'11','assistantphone','Assistant Phone',1,1,'',100,19,4,1,'V~O',1,null,'ADV',1)");
		...
		$this->db->query("insert into vtiger_field values (18," . $this->db->getUniqueID("vtiger_field") . ",'phone','vtiger_vendor',1,'11','phone','Phone',1,2,'',100,4,$vendorbasicinfo,1,'V~O',2,2,'BAS',1)");
/////////////////////////////////  2o telefono e fax - info@greenbitweb.com  /////////////////////////////////
$this->db->query("insert into vtiger_field values (18," . $this->db->getUniqueID("vtiger_field") . ",'phone2','vtiger_vendor',1,'11','phone2','Phone 2',1,2,'',100,5,$vendorbasicinfo,1,'V~O',2,2,'BAS',1)");
$this->db->query("insert into vtiger_field values (18," . $this->db->getUniqueID("vtiger_field") . ",'fax','vtiger_vendor',1,'11','fax','Fax',1,2,'',100,6,$vendorbasicinfo,1,'V~O',2,2,'BAS',1)");
/////////////////////////////////
		...
		$this->db->query("insert into vtiger_field values (18," . $this->db->getUniqueID("vtiger_field") . ",'website','vtiger_vendor',1,'17','website','Website',1,2,'',100,15,$vendorbasicinfo,1,'V~O',1,null,'BAS',1)");
		$this->db->query("insert into vtiger_field values (18," . $this->db->getUniqueID("vtiger_field") . ",'glacct','vtiger_vendor',1,'15','glacct','GL Account',1,2,'',100,16,$vendorbasicinfo,1,'V~O',1,null,'BAS',1)");
		$this->db->query("insert into vtiger_field values (18," . $this->db->getUniqueID("vtiger_field") . ",'category','vtiger_vendor',1,'15','category','Category',1,2,'',100,8,$vendorbasicinfo,1,'V~O',1,null,'BAS',1)");
...
/////////////////////////////////  P.iva e CF  By Greenbitweb - info@greenbitweb.com  /////////////////////////////////
        $this->db->query("insert into vtiger_field values (18," . $this->db->getUniqueID("vtiger_field") . ",'partitaiva','vtiger_vendor',1,'1','partitaiva','Partita IVA',1,2,'',30,13,$vendorbasicinfo,1,'V~O',1,null,'BAS',1)");
        $this->db->query("insert into vtiger_field values (18," . $this->db->getUniqueID("vtiger_field") . ",'codicefiscale','vtiger_vendor',1,'1','codicefiscale','Codice Fiscale',1,2,'',30,14,$vendorbasicinfo,1,'V~O',1,null,'BAS',1)");
/////////////////////////////////
		//Block 46
...
//for Support end notification before a month
		...
		$this->db->query("insert into vtiger_inventorytaxinfo values($vatid,'tax" . $vatid . "','IVA','22.00','0')");
		$this->db->query("insert into vtiger_inventorytaxinfo values($salesid,'tax" . $salesid . "','Commissioni','0.00','0')");
		$this->db->query("insert into vtiger_inventorytaxinfo values($serviceid,'tax" . $serviceid . "','Altro','0.00','0')");
		...
		$this->db->query("insert into vtiger_shippingtaxinfo values($shvatid,'shtax" . $shvatid . "','IVA','22.00','0')");
		$this->db->query("insert into vtiger_shippingtaxinfo values($shsalesid,'shtax" . $shsalesid . "','Commissioni','0.00','0')");
		$this->db->query("insert into vtiger_shippingtaxinfo values($shserviceid,'shtax" . $shserviceid . "','Altro','0.00','0')");

	...
	<div class="row-fluid main-container">
		<div class="inner-container">
				...
				<div class="row-fluid offset2">
					<div class="span8 pull-right">
						<div class="button-container">
							<a href ="#">
								<input type="button" class="btn btn-large btn-primary" value="{vtranslate('LBL_RECHECK', 'Install')}" id='recheck'/>
							</a>
						</div>
					</div>
				</div>
			...
			<div class="row-fluid offset2">
				<div class="span8">
					<div class="button-container">
						<input type="button" class="btn btn-large btn-primary" value="{vtranslate('LBL_BACK', 'Install')}" name="back"/>

<?php /* Smarty version Smarty-3.1.7, created on 2015-09-08 05:29:45
         compiled from "D:\xampp\htdocs\demo38\includes\runtime/../../layouts/vlayout2\modules\Vtiger\EditViewBlocks.tpl" */ ?>
<?php /*%%SmartyHeaderCode:144055ee72496e5de0-30613554%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '97a5bb07f3719df32f7c5a86bb93278e9aede261' => 
    array (
      0 => 'D:\\xampp\\htdocs\\demo38\\includes\\runtime/../../layouts/vlayout2\\modules\\Vtiger\\EditViewBlocks.tpl',
      1 => 1441632367,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '144055ee72496e5de0-30613554',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55ee7249a491a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55ee7249a491a')) {function content_55ee7249a491a($_smarty_tpl) {?>
...
?><?php if (count($_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value)<=0){?><?php continue 1?><?php }?><div class="table table-bordered blockContainer showInlineTable equalSplit fdsf"><div><div class="main_heading"><div class="blockHeader" colspan="4"><?php echo vtranslate($_smarty_tpl->tpl_vars['BLOCK_LABEL']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
</div></div></div><div><div class="detail-row-full"><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(0, null, 0);?><?php  $_smarty_tpl->tpl_vars['FIELD_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['FIELD_MODEL']->_loop = false;
...
?><?php $_smarty_tpl->tpl_vars["isReferenceField"] = new Smarty_variable($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType(), null, 0);?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=="20"||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=="19"){?><?php if ($_smarty_tpl->tpl_vars['COUNTER']->value=='1'){?><div class="width30-per <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></div><div class="width20-per <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
...
<?php }?><?php if ($_smarty_tpl->tpl_vars['isReferenceField']->value!="reference"){?></label><?php }?></div><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="83"){?><div class="width20-per fieldValue <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
...
</span></div></div><?php }?><?php if (count($_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value)==1&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="19"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="20"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="30"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')!="recurringtype"){?><div class="width30-per <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></div><div class="width20-per <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
...
<?php }?><?php } ?><?php if (end($_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value)==true&&count($_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value)!=1&&$_smarty_tpl->tpl_vars['COUNTER']->value==1){?><div class="width30-per fieldLabel <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></div><div class="width20-per <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></div><?php }?></div></div></div><br><?php } ?></div><?php }} ?>
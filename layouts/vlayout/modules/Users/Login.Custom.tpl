		...
		<div class="container-fluid login-container">
			...
			<div class="row-fluid">
				...
				<div class="span3">
					...
					<a target="_blank" href="http://www.opencrmitalia.com">Opencrmitalia - Il portale italiano per il CRM open source</a>
			...
			{/if}
												...
												<div class="control-group">
													...
													<label class="control-label" for="username"><b>Nome utente</b></label>

 ...
 */
class Accounting_Record_Model extends Inventory_Record_Model {

	public function getCreateInvoiceUrl() {
		$invoiceModuleModel = Vtiger_Module_Model::getInstance('Invoice');

		return "index.php?module=".$invoiceModuleModel->getName()."&view=".$invoiceModuleModel->getEditViewName()."&accountingid=".$this->getId();
	}

	public function getCreateSalesOrderUrl() {
		$salesOrderModuleModel = Vtiger_Module_Model::getInstance('SalesOrder');

		return "index.php?module=".$salesOrderModuleModel->getName()."&view=".$salesOrderModuleModel->getEditViewName()."&accountingid=".$this->getId();
	}
	...
	function getInventoryCurrencyInfo($module, $id)	{
		...
		$log->debug("Entering into function Accounting_Record_Model getInventoryCurrencyInfo($module, $id).");

		$inv_table_array = Array('Accounting'=>'green_accounting');
		$inv_id_array = Array('Accounting'=>'accountingid');
		...
		$log->debug("Exit from function Accounting_Record_Model getInventoryCurrencyInfo($module, $id).");
	...
	function getAssociatedProducts($module,$focus,$seid='')	{
		global $log;
		$log->debug("Entering Accounting_Record_Model getAssociatedProducts(".$module.",".get_class($focus).",".$seid."='') method ...");
		global $adb;
		$output = '';
		...
		$log->debug("Exiting Accounting_Record_Model getAssociatedProducts method ...");

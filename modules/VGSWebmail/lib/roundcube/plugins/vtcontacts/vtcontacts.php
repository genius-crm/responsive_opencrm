...
require_once(dirname(__FILE__) . '/vtcontacts_backend.php');
...
class vtcontacts extends rcube_plugin
{
  ...
  {
    $abook = new vtcontacts_backend($this->abook_name);
  ...
  public function get_address_book($p)
  {
    if ($p['id'] === $this->abook_id) {
      $p['instance'] = new vtcontacts_backend($this->abook_name);
    }

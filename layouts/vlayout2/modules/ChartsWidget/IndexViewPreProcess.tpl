...
<div class="bodyContents">
	<div class="mainContainer row-fluid">
		...
		{/if}
		{if $VIEW_TYPE eq 'ChartDetail'}
		<div class="contentsDiv marginLeftZero" id="rightPanel" style="min-height:550px; background-color:#fff; border-left: 0px; ">
		{/if}
